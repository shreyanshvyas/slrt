        ...
        <section className="bg-[#F3F3F3] py-24">
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className="text-center">
                    <h2 className="text-5xl font-serif italic text-black">Featured Programs</h2>
                    <p className="mt-2 text-gray-600 text-lg">Check out some of our most popular courses!</p>
                </div>
